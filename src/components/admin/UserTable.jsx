...
const UserTable = () => {
    ...
    useEffect(() => {
        ...
        const apiRoles = new RoleService();
        apiRoles.listRoles()
            .then(res => {
    ...
    const handleDeactivate = () => {
        apiService.deleteUser(dataToDeactivate.id)
            .then(() => {
    ...
    return (
        <div className="clients-table">
            ...
            <AdminModal
                isOpen={modalOpen}
                templateData={{ userName: '', password: '', role: roleData }}
                placeholderData={['Usuario', 'Contraseña', 'Rol']}
                typeData={['text', 'password', 'select']}
                title='Usuario'
                onCancel={() => {
                    setModalOpen(false);
                    setEditingData(null);
